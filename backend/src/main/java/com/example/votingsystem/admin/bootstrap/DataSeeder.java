...
public class DataSeeder {
    ...
    CommandLineRunner seedDummyData(
        ...
        return args -> {
            ...
            // ── 1. Students ─────────────────────────────────────────
            Student s1 = makeStudent("STU001", "Kavisha Lakshan",  "kavisha@university.edu",  enc.encode("pass123"), Gender.MALE);
            Student s2 = makeStudent("STU002", "Nimasha Perera",   "nimasha@university.edu",  enc.encode("pass123"), Gender.FEMALE);
            Student s3 = makeStudent("STU003", "Tharuka Silva",    "tharuka@university.edu",  enc.encode("pass123"), Gender.MALE);
            Student s4 = makeStudent("STU004", "Sanduni Fernando", "sanduni@university.edu",  enc.encode("pass123"), Gender.FEMALE);
            Student s5 = makeStudent("STU005", "Dineth Jayasuriya","dineth@university.edu",   enc.encode("pass123"), Gender.MALE);
            Student s6 = makeStudent("STU006", "Ishara Kumari",    "ishara@university.edu",   enc.encode("pass123"), Gender.FEMALE);
            Student s7 = makeStudent("STU007", "Ravindu Bandara",  "ravindu@university.edu",  enc.encode("pass123"), Gender.MALE);
            Student s8 = makeStudent("STU008", "Chamodi Wijesinghe","chamodi@university.edu", enc.encode("pass123"), Gender.FEMALE);
            Student s9 = makeStudent("STU009", "Ashan De Silva",   "ashan@university.edu",    enc.encode("pass123"), Gender.MALE);
            Student s10= makeStudent("STU010", "Nethmi Rodrigo",   "nethmi@university.edu",   enc.encode("pass123"), Gender.FEMALE);
            studentRepo.saveAll(List.of(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10));

            // ── 2. Events ───────────────────────────────────────────
            Event event1 = new Event();
            event1.setName("Bright Future Student Awards 2026");
            event1.setDescription("Annual student awards ceremony recognizing outstanding academic achievements and extracurricular contributions.");
            ...
            Nominee n1 = makeNom("Kavisha Lakshan",   "4.0 GPA, Dean's List 6 semesters running. Published 2 research papers in AI.", cat1);
            Nominee n2 = makeNom("Nimasha Perera",    "3.95 GPA, National Science Olympiad gold medalist. Tutors junior students.", cat1);
            Nominee n3 = makeNom("Ashan De Silva",    "3.89 GPA, Full scholarship recipient. Top performer in every module.", cat1);

            // Cat 2 — Best Community Leader (3 nominees)
            Nominee n4 = makeNom("Sanduni Fernando",  "President of Student Council. Led campus sustainability initiative.", cat2);
            Nominee n5 = makeNom("Tharuka Silva",     "Founded university coding bootcamp. Mentored 50+ juniors.", cat2);
            Nominee n6 = makeNom("Ishara Kumari",     "Organized 12 charity events. Raised over Rs. 2M for underprivileged students.", cat2);

            // Cat 3 — Best Innovator (3 nominees)
            Nominee n7 = makeNom("Dineth Jayasuriya", "Built an AI-powered campus navigation app used by 3,000+ students.", cat3);
            Nominee n8 = makeNom("Ravindu Bandara",   "Developed a solar-powered IoT system for smart agriculture.", cat3);
            Nominee n9 = makeNom("Nethmi Rodrigo",    "Created an award-winning AR application for medical training.", cat3);

            // Cat 4 — Best Sportsperson (3 nominees)
            Nominee n10= makeNom("Chamodi Wijesinghe","University athletics champion. National record in 100m sprint.", cat4);
            Nominee n11= makeNom("Kavisha Lakshan",   "Captain of university cricket team. Led team to inter-university finals.", cat4);
            ...
            Nominee n14= makeNom("Nimasha Perera",    "Co-authored a Nature publication on biomedical engineering.", cat5);
            ...
            Nominee n16= makeNom("Ishara Kumari",     "500+ hours of community service. Teaches coding at rural schools.", cat6);
            ...
            nomineeRepo.saveAll(List.of(n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,n17,n18));
            ...
            System.out.println("   → 10 students (password: pass123)");
    ...
    private Notification makeNotif(String recipient, String subject, String body, Notification.Status status, Instant sentAt) {
